    ...
    for (const call of msg.tool_calls) {
      ...
      try {
        ...
        if (repeat >= 2) {
          ...
          result = { note: 'Tohle už jsi volal se stejnými parametry — výsledek se nezmění. Neopakuj dotazy. Pokud máš dost informací, PROVEĎ změnu: u vzhledu zavolej set_custom_css s kompletním CSS, u textu set_content. Jinak rovnou napiš odpověď uživateli.' };
